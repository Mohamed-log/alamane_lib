...
const ContactUs = () => {
  return (
    <>
      <img src={Qr} alt="Qr " className=" w-2/12 mx-auto mt-10" />
      <h1 className="text-center text-green-500 text-2xl font-bold mt-6 mb-4">Scan me</h1>
      ...
      <footer class="flex flex-col items-center bg-neutral-900 text-center text-white">
        <div class="container px-6 pt-6">
          <div class="mb-6 flex justify-center">
            ...
            <a
              href="https://www.instagram.com/alamane_lib/?igsh=bWhlN25nZG9neW9x"
              type="button"
              class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
              data-te-ripple-init
              data-te-ripple-color="light"
        ...
        <div class="w-full p-4 text-center bg-zinc-800">
          © Copyright: AL AMANE LIBRAIRIE
        </div>
      </footer>
    </>
  );
